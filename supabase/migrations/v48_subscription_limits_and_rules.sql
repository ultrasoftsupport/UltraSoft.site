...
CREATE TABLE IF NOT EXISTS public.subscription_plan_limits (
    ...
    max_products integer NOT NULL DEFAULT 200, -- -1 for unlimited (active models)
    max_total_products integer NOT NULL DEFAULT 500, -- -1 for unlimited (active + inactive models)
    max_invoices integer NOT NULL DEFAULT 1000, -- -1 for unlimited
...
ALTER TABLE public.subscription_plan_limits ADD COLUMN IF NOT EXISTS max_total_products integer NOT NULL DEFAULT 500;
ALTER TABLE public.subscription_plan_limits ADD COLUMN IF NOT EXISTS max_invoices integer NOT NULL DEFAULT 1000;
...
VALUES
('quarterly', 200, 500, 1000, 4, 200, 'monthly', 'per_item', 5, 1, 50, 1, 1, 1),
('semi_annual', 600, 1500, 3000, 10, 500, 'monthly', 'per_item', 5, 1, 50, 0.8, 0.8, 0.8),
('annual', -1, -1, -1, 25, -1, 'monthly', 'per_operation', 0, 0, 0, 0, 0, 0)
