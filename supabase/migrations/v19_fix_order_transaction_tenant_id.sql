-- =========================================================================
-- 🚀 MIGRATION V19: FIX PROCESS_ORDER_TRANSACTION TENANT_ID INJECTION
-- 📦 Project: UltraSoft (ألترا سوفت)
-- 📅 Date: 2026-08-02
-- 💡 Description: Fixes process_order_transaction PL/pgSQL function to 
--    explicitly save tenant_id into public.orders and public.stock_movements,
--    and retroactively fixes any unassigned orders.
-- =========================================================================
...
-- Fix any unassigned existing orders by attaching tenant_id from their creator system_user
UPDATE public.orders o
SET tenant_id = u.tenant_id
FROM public.system_users u
WHERE o.worker_id = u.id AND (o.tenant_id IS NULL OR o.tenant_id = '00000000-0000-0000-0000-000000000001');
